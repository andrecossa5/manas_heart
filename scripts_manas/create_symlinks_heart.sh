#!/usr/bin/env bash
##############################################################################
# create_symlinks_heart.sh
#   For every sample listed in heart_samples.csv, create symbolic links in
...
# ──────────────────────────  paths ──────────────────────────
TARGET_DIR="/lustre/scratch125/cellgen/behjati/ac87/manas_heart/work/heart"
SAMPLE_CSV="$(dirname "$0")/heart_samples.csv"

mkdir -p "$TARGET_DIR"

# ─────────────────────────  projects ────────────────────────
projects=(3137 3152 3186 3254)
